...
public enum Key {
    ...
    DELEGATE_SCRIPT_ENGINE("delegate_script.engine"),
    ...
    DYNAMODBCACHE_ACCESS_KEY_ID("DynamoDBCache.access_key_id"),
    DYNAMODBCACHE_ENDPOINT("DynamoDBCache.endpoint"),
    DYNAMODBCACHE_SECRET_KEY("DynamoDBCache.secret_key"),
    DYNAMODBCACHE_TABLE_NAME("DynamoDBCache.table.name"),
